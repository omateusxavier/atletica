...
<head>
  ...
  <title><?php echo $this->configsite->TITULOSITE; ?> - Posicoes</title>
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Posições</li>
      </ol>
        ...
        <div class="row">
          ...
          <div class="col-sm">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_novo"><i
                class="fa fa-plus" aria-hidden="true"></i> Nova Posição</button>
          </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          if(count($posicoes) > 0){
            ...
            echo "<table id='tab_posicao' class='table table-hover table-condensed table-striped'>
                <thead>
                  <tr>
                    <th>Cód:.</th>
                    <th>Descrição</th>
            ...
            foreach($posicoes as $val){
              ...
              echo "<tr>
                      ...
                      <td class='text-center'>
                        <a href='" . base_url("Posicoes/editar/" . $val->IDPOSICAO) . "' class='btn btn-primary btn-sm' data-toggle='tooltip' data-placement='top' title='Editar'><i class='fa fa-pencil'></i></a>
                        
                        <button class='btn btn-danger btn-sm btnExcluir' title='Excluir' data-idposicao='" . $val->IDPOSICAO . "'><i class='fa fa-times'></i></button>
                      </td>
                  </tr>";
    ...
    <div class="modal-dialog modal-primary" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title"><i class="fa fa-plus" aria-hidden="true"></i> Nova Posição</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
              aria-hidden="true">&times;</span></button>
        </div>

        <form id="formNovo" method="post" action="<?php echo base_url("Posicoes/inserir"); ?>">
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="modal_excluir">
    <div class="modal-dialog modal-danger" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title"><i class="fa fa-times" aria-hidden="true"></i> Excluir Posicao</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
              aria-hidden="true">&times;</span></button>
        </div>

        <form id="formExcluir" method="post" action="<?php echo base_url("Posicoes/excluir"); ?>">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <input type="hidden" id="txtIdPosicao_del" name="txtIdPosicao_del" value="" />

                Tem certeza que deseja excluir a posição selecionada?
  ...
  $(function() {
    ...
    $(document).on('click', '.btnExcluir', function() {
      ...
      var idposicao = $(this).attr('data-idposicao');
      $('#txtIdPosicao_del').val(idposicao);
