...
<head>
  ...
  <title><?php echo $this->configsite->TITULOSITE; ?> - Candidatos</title>
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
        ...
        <div class="row">
          ...
          <div class="col-sm">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_novo"><i
                class="fa fa-plus" aria-hidden="true"></i> Novo Candidato</button>
          </div>
        ...
        <?php 
          if(isset($_GET['ret'])){
            if($_GET['ret'] == 'S'){
              ...
              echo "<div class='alert alert-danger'>Erro ao adicionar candidato. O RA já esta cadastrado!</div>";
            }
          }
        ?>
          ...
          <div class="col-md table-responsive">
            ...
            <?php
              ...
              if(count($candidatos) > 0){
                ...
                echo "<table id='tab_candidatos' class='table table-hover table-condensed table-striped'>
                    <thead>
                      <tr>
                        <th>RA:.</th>
                        <th>Foto</th>
                  ...
                  foreach($candidatos as $val){
                    ...
                    echo "<tr>
                            ...
                            <td class='text-center'>
                              <a href='" . base_url("Candidatos/editar/" . $val->IDALUNO) . "' class='btn btn-primary btn-sm' data-toggle='tooltip' data-placement='top' title='Editar'><i class='fa fa-pencil'></i></a>
                              
                              <button class='btn btn-danger btn-sm btnExcluir' title='Excluir' data-idcandidato='" . $val->IDALUNO . "'><i class='fa fa-times'></i></button>
                            </td>
                        </tr>";
    ...
    <div class="modal-dialog modal-primary modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title"><i class="fa fa-plus" aria-hidden="true"></i> Novo Candidato</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
              aria-hidden="true">&times;</span></button>
        </div>

        <form id="formNovo" method="post" enctype="multipart/form-data"
          action="<?php echo base_url("Candidatos/inserir"); ?>">
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="modal_excluir">
    <div class="modal-dialog modal-danger" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title"><i class="fa fa-times" aria-hidden="true"></i> Excluir Candidato</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
              aria-hidden="true">&times;</span></button>
        </div>

        <form id="formExcluir" method="post" action="<?php echo base_url("Candidatos/excluir"); ?>">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <input type="hidden" id="txtIdCandidato_del" name="txtIdCandidato_del" value="" />
  ...
  $(function() {
    ...
    $(document).on('click', '.btnExcluir', function() {
      ...
      $('#txtIdCandidato_del').val(idcandidato);
